...
<body>
<form id="payment_form" action="payment_confirmation" method="post">
    <input type="hidden" name="access_key" value="082e6e3cae923607a61bb6181ab94740">
    <input type="hidden" name="profile_id" value="8B41C554-0E10-480F-A110-F57FB4EBE229">
